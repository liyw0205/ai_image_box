...
`https://github.com/liyw0205/ai_image_box` 已进入 Android 原生工程开发。0.3.3 文生图初版增强已经完成，包含四 Tab 主界面、创作表单、任务队列取消/重试/清理、重启恢复、失败响应预览详情、历史缩略图、参数复用、多图结果落盘、基础渠道管理、模型列表测试、API Key 加密保存、Termux 打包脚本和 logcat 脚本。
...
```text
/data/data/com.termux/files/home/devwork/AIImageBox_0.3.3_debug.apk
```
