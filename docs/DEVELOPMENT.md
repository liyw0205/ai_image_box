...
```text
/data/data/com.termux/files/home/devwork/AIImageBox_0.5.3_debug.apk
```
...
| 网络 | OkHttp |
| 本地文件 | 应用私有目录 + SAF 导出 |
| 任务后台 | 当前生图和生视频队列由 Application 生命周期持有；后续补 ForegroundService 通知和系统级保活，可再补 WorkManager |
